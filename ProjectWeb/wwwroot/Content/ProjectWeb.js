...
(function(Global)
{
 ...
 {
  return Doc.Element("section",[AttrProxy.Create("class","section")],[Doc.Element("h2",[AttrProxy.Create("class","subtitle")],[Doc.TextNode("Contact Manager")]),Doc.Element("p",[AttrProxy.Create("class","subhead")],[Doc.TextNode("A simple Website that stores, Updates and Deletes Contact Information")]),Doc.Element("div",[AttrProxy.Create("class","field")],[Doc.Element("label",[AttrProxy.Create("class","label")],[Doc.TextNode("First name: "),Doc.Input([AttrProxy.Create("class","input")],firstName)]),ContactManager.ShowErrorsFor(View$1.Through$1(submit.view,firstName))]),Doc.Element("div",[AttrProxy.Create("class","field")],[Doc.Element("label",[AttrProxy.Create("class","label")],[Doc.TextNode("Last name: "),Doc.Input([AttrProxy.Create("class","input")],lastName)]),ContactManager.ShowErrorsFor(View$1.Through$1(submit.view,lastName))]),Doc.Element("div",[AttrProxy.Create("class","field")],[Doc.Element("label",[AttrProxy.Create("class","label")],[Doc.TextNode("Email: "),Doc.EmailInput([AttrProxy.Create("class","input")],email)]),ContactManager.ShowErrorsFor(View$1.Through$1(submit.view,email))]),Doc.Element("div",[AttrProxy.Create("class","field")],[Doc.Element("label",[AttrProxy.Create("class","label")],[Doc.TextNode("Phone: "),Doc.Input([AttrProxy.Create("class","input")],phone)]),ContactManager.ShowErrorsFor(View$1.Through$1(submit.view,phone))]),Doc.Element("div",[AttrProxy.Create("class","field")],[Doc.Element("label",[AttrProxy.Create("class","label")],[Doc.TextNode("Address: "),Doc.Input([AttrProxy.Create("class","input")],address)]),ContactManager.ShowErrorsFor(View$1.Through$1(submit.view,address))]),Doc.Element("div",[],[Doc.Button("Submit",[AttrProxy.Create("class","button")],function()
  {
   submit.Trigger();
